...
_HAS_CATALOG_CREDS = bool(
    os.environ.get("SHOP_SHOPIFY_CLIENT_ID") and os.environ.get("SHOP_SHOPIFY_CLIENT_SECRET")
)
...
class TestShopifyCatalogSearch:
    ...
    def test_search_returns_results(self, shop_home):
        ...
        shop(
            ...
            "connect-shopify",
            "--client-id",
            os.environ["SHOP_SHOPIFY_CLIENT_ID"],
            "--client-secret",
            os.environ["SHOP_SHOPIFY_CLIENT_SECRET"],
        )
        ...
        result = shop(
            shop_home, "search", "products", "coffee filters", "--max-price", "50", expect_exit=5
        )
    ...
    def test_search_result_fields(self, shop_home):
        ...
        result = shop(shop_home, "search", "products", "coffee", expect_exit=5)
    ...
    def test_search_max_price_filter(self, shop_home):
        ...
        result = shop(shop_home, "search", "products", "coffee", "--max-price", "10", expect_exit=5)
...
class TestShopifyUCPCheckout:
    ...
    def test_ucp_checkout_end_to_end(self, shop_home, mandate_id):
        ...
        shop(
            ...
            "add-shop-pay",
            "--token",
            os.environ["SHOP_SHOPIFY_SHOP_PAY_TOKEN"],
            "--email",
            "test@example.com",
            "--first-name",
            "Test",
        ...
        search = shop(
            shop_home, "search", "products", "test product", "--max-price", "50", expect_exit=5
        )
